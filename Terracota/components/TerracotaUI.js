...
const recursosIconos = {
  ...
  pedido: require('../assets/Pedidos.png'),
  ...
  registrarPedido: require('../assets/RegistrarPedido.png'),
  ...
  return (
    <SafeAreaView style={styles.phoneSafe}>
      <View style={styles.phone}>
        {children}
        {mostrarNavegacion && elementosNavegacion.length > 0 && (
          <View style={styles.roleNav}>
            {elementosNavegacion.map((elemento) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}>
                <Icono icono={elemento.icono} tono="light" tamaño={22} />
