          ...
          {etapa === 'pendiente' && (
            <View style={styles.actionRow}>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.prepButtonText}>INICIAR PREP.</Text>
              </TouchableOpacity>
            </View>
          )}
          ...
          {etapa === 'preparando' && (
            <View style={styles.readyActionContainer}>
              <TouchableOpacity
                ...
                onPress={avanzarPedido}
                activeOpacity={0.82}>
                <Icono icono="listo" tono="light" tamaño={20} />
                <Text style={styles.readyButtonText}>¡PEDIDO LISTO!</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.backButtonCenter} onPress={() => cambiarPantalla(pantallaRegreso)}>
                <Text style={styles.backButtonText}>REGRESAR</Text>
              </TouchableOpacity>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  readyActionContainer: { alignItems: 'center', gap: 16, marginTop: 8, marginBottom: 8 },
  readyButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: '#2D9E5F', borderRadius: 20, height: 48, width: '100%', shadowColor: '#1A6B3F', shadowOpacity: 0.3, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  readyButtonText: { color: '#FFFFFF', fontSize: 15, fontWeight: '900', letterSpacing: 0.5 },
});
